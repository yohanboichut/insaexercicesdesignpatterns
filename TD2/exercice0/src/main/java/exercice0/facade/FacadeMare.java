...
public class FacadeMare {
     ...
     */
    private Mare maMare;
    private CompteurMorts compteurMorts;
    private CompteurEtourdissements compteurEtourdissements;


    public CompteurMorts getCompteur() {
        return compteurMorts;
    }
    ...
    public FacadeMare() {
        ...
        this.compteurMorts = new CompteurMorts();
        this.compteurEtourdissements = new CompteurEtourdissements();
    }

    public CompteurEtourdissements getCompteurEtourdissements() {
        return compteurEtourdissements;
    }
    ...
    public void creerMare(int dimXMare, int dimYMare, int nbPoissons) {
        ...
        for (int i =0;i<nbPoissons;i++) {
             ...
             */
            new Poisson(posx,posy,maMare, compteurMorts,compteurEtourdissements);
        }
